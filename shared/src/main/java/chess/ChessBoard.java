...
public class ChessBoard {
    ...
    public boolean equals(Object o) {
        ...
        for (int rowIndex = 0; rowIndex < 8; rowIndex++) {
            for (int colIndex = 0; colIndex < 8; colIndex++) {
                ...
                boolean piecesNotEqual = notNull && !(chessPieces[rowIndex][colIndex].equals(that.chessPieces[rowIndex][colIndex]));
                if (chessPieces[rowIndex][colIndex] == null && that.chessPieces[rowIndex][colIndex] != null) {
                    return false;
                } else if (piecesNotEqual) {
                    return false;
                }
            }
        }
    ...
    public void resetBoard() {
        this.chessPieces = new ChessPiece[8][8];
        for(int col = 1; col < 9; col++) { // Add Pawns
